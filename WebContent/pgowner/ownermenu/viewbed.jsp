...
<select onchange="getBedDetails(this.value,<%=ownerId %>);">
...
<tr height="50"><td><h3>Bed Details Under Selected PG and</h3></td></tr>
<tr valign="top"><td><div id="getBedDetails"></div></td></tr>
</table>